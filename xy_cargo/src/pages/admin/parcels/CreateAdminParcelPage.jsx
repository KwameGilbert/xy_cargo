...
import mockParcelData from '../../../components/admin/parcels/mockData'; // Assuming mock data for demonstration
  ...
  useEffect(() => {
    ...
    try {
      const timer = setTimeout(() => {
        const parcelData = mockParcelData.find(p => p.id === id); // Fetching parcel by ID from mock data
