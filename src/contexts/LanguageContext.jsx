...
const translations = {
  en: {
    ...
    'nav.contact': 'Contact',
    'hero.title': 'Global Shipping Made Simple',
    'hero.subtitle': 'Fast, reliable, and affordable international shipping solutions for businesses and individuals worldwide.',
    'button.getQuote': 'Get Quote',
    'button.trackPackage': 'Track Package',
    'pricing.title': 'Transparent Pricing',
    'pricing.subtitle': 'No hidden fees, no surprises. Simple, weight-based pricing for destinations worldwide.',
