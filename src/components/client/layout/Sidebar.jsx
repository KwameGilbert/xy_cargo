  ...
  return (
    <div className="h-full">
      ...
      <aside
        ...
        } lg:translate-x-0 fixed lg:relative inset-y-0 left-0 z-40 w-60 bg-white border-r border-gray-100 h-full flex flex-col transition-transform duration-300 ease-in-out`}
      >
        {/* Logo Section */}
