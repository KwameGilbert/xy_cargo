    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center text-gray-400">
                ...
                <span>+260 96 7379139</span>
              </div>
              <div className="flex items-center text-gray-400">
                <Mail size={16} className="mr-2 text-red-500" />
                <span>support@xycargozm.com</span>
              </div>
              <div className="flex items-center text-gray-400">
                <MapPin size={16} className="mr-2 text-red-500" />
                <span>Shop # 94 Carousel Mall, Lusaka, Zambia</span>
              </div>
            </div>
            <div className="mt-4">
              <p className="text-gray-400 text-sm font-semibold">Working Hours:</p>
              <p className="text-gray-400 text-sm">8:00am-5:00pm (Zambia Time)</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://wa.me/260967379139" className="text-gray-400 hover:text-red-500">Electronics Shipping</a></li>
              <li><a href="https://wa.me/260769481203" className="text-gray-400 hover:text-red-500">Special Goods Handling</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="space-y-1">
                <p className="text-gray-400 text-xs">+260 96 7379139</p>
                <p className="text-gray-400 text-xs">+260 769 481 203</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© 2025 XY CARGO ZAMBIA. All rights reserved. China to Zambia Shipping Specialists.</p>
