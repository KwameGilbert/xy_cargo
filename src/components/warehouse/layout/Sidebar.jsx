...
const menuItems = [
  ...
  { path: "/warehouse/parcels", label: "Parcels", icon: Package },
  { path: "/warehouse/payments", label: "Payments & Invoices", icon: CreditCard },
  { path: "/warehouse/shipments", label: "Shipments", icon: Ship },
  { path: "/warehouse/notifications", label: "Notifications", icon: Bell },
  { path: "/warehouse/support", label: "Support", icon: Headphones },
  { path: "/warehouse/bulk-updates", label: "Bulk Updates", icon: FileText },
