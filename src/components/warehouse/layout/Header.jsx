...
const Header = () => {
  ...
  const handleLogout = () => {
    ...
    navigate("/warehouse/auth/login");
  };

  return (
    <header className="bg-white shadow">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <Link to="/warehouse/dashboard" className="flex items-center">
          <img
            src="/images/logo/xy-cargo-logo.svg"
            alt="XY Cargo Logo"
            className="h-8 w-auto"
          />
          <span className="ml-2 text-xl font-semibold text-gray-900">Warehouse Portal</span>
        </Link>
